	...
	window.addEventListener("mousemove", function(event)
	{
    	...
    	if(tmp_s != status && DFA >= 0)
    	{
			...
			switch(DFA)
			{
				...
				case 5:
                    //提示玩家作弊
                    $("#dynatic").html("Don't cheat, you should start from the 'S' and move to the 'E' inside the maze");
                    //重新开始游戏
					DFA = -1;
					break;
				case 7:
                    //提示玩家胜利
                    $("#dynatic").html("You Win");
                    //重新开始游戏
					DFA = -1;
					break;
			}
...
function recover()
{
    $("#generate_button").css({"transform" : "translate(3px, 3px)", "box-shadow" : "0px 0px 0px 0 #25527a", "background-color" : "#25527a"})
}
...
function init()
{
    ...
    //更改初始化按键的呈现效果
    $("#generate_button").css({"transform" : "translate(-3px, -3px)", "box-shadow" : "5px 5px 0px 0 #25527a", "background-color" : "#167bd4"})
